...
const ImageSlider = () => {
    return (
        <div className="bg-gray-50">
             <h1 className='text-5xl text-center font-semibold mb-4 text-gray-900'>Trending Offers</h1>
             <p className='text-center text-xl font-medium text-gray-700 mb-10'>Recharge your prepaid account or pay bill of your postpaid account here.</p>
